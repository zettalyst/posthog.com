...
궁금한 점이 있으신가요? [데모영상을 시청](https://posthog.com/demo)하거나 [담당자와 상담](https://posthog.com/talk-to-a-human)하세요.
...
## 데이터 팀을 위해 설계되고 프로덕트 팀에서도 사랑받는 PostHog 데이터 스택
...
우리의 인기 프로덕트에 대한 요금 책정 방식을 소개합니다:
...
- **투명성.** 당사의 [기업 안내서](https://posthog.com/handbook), [영업 매뉴얼](https://posthog.com/handbook/growth/sales/overview) 및 [회사 전략](https://posthog.com/handbook/why-does-posthog-exist)을 읽어보실 수 있습니다.
- **빠른 배포.** [변경 내역](https://posthog.com/changelog)을 확인하세요.
...
- [데모 영상](https://posthog.com/demo)
- [기술 문서](https://posthog.com/docs)
- [API](https://posthog.com/docs/api)
- [문의](https://posthog.com/questions)
- [PostHog 팀 소개](https://posthog.com/teams)
